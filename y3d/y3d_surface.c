...
//  SURFACE( 91, 1);  
  ...
  SURFACE(121, 3); surfaces->item[121].mode = DRAW_MODE_COLORKEY;
  SURFACE(122, 1); surfaces->item[122].mode = DRAW_MODE_COLORKEY;
  SURFACE(123, 1);
  SURFACE(124, 2); surfaces->item[124].mode = DRAW_MODE_COLORKEY;
  SURFACE(125, 2); surfaces->item[125].mode = DRAW_MODE_BLEND;
