...
#define YETI_RGBA5551

//#define YETI_MEDIUM_QUALITY_CLIPPING
//#define YETI_MEDIUM_QUALITY_PROJECTION
//#define YETI_LOW_QUALITY_CLIPPING
//#define YETI_LOW_QUALITY_PROJECTION

#define YETI_VIEWPORT_INTERVAL 50
#define YETI_VIEWPORT_X1 0
#define YETI_VIEWPORT_Y1 0
#define YETI_VIEWPORT_X2 256
#define YETI_VIEWPORT_Y2 240
#define YETI_FRAMEBUFFER_WIDTH 256
...
#define YETI_VIEWPORT_X1 0
#define YETI_VIEWPORT_Y1 0
#define YETI_VIEWPORT_X2 800
#define YETI_VIEWPORT_Y2 600
#define YETI_FRAMEBUFFER_WIDTH 800
#define YETI_FRAMEBUFFER_HEIGHT 600
...
#ifdef YETI_RGBA5551
#define RGB_BLEND_MASK  0xF7BC
#define RGB_SET(R,G,B)  (((R)<<11)|((G)<<6)|((B)<<1))
#define RGB_RED(A)      (((A)>>11)&31)
#define RGB_GREEN(A)    (((A)>> 6)&31)
#define RGB_BLUE(A)     (((A)>> 1)&31)
#endif
...
#ifdef __N64__
#define RGB_BLEND(A,B)        ( ((((A) ^ (B)) & RGB_BLEND_MASK) >> 1) + ((A) & (B)) )
#else
