...
extern int game_mode(game_t* game);

extern void game_load_map(yeti_t* yeti, rom_map_t* map);
extern void game_spawn_entities(yeti_t* yeti);

extern void player_init(entity_t* e);
extern void player_tick(yeti_t* yeti, entity_t* e);

extern void Yeti_Go_Episode(void);
