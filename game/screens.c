...
void screen_menu(yeti_t* yeti)
{
  ...
  if (yeti->game.menu.main < 0) yeti->game.menu.main = 0;
  if (yeti->game.menu.main > 3) yeti->game.menu.main = 3;
  ...
  draw_string(yeti->viewport.back, ((YETI_TEXTPORT_WIDTH >> 1) - 10) >> 1, 1, "The Temple", 4, 4, DRAW_MODE_COLORKEY, 0);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 8) >> 1, 2, "New Game"     , 4, 5, yeti->game.menu.main == 0);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 7) >> 1, 3, "Options"      , 4, 5, yeti->game.menu.main == 1);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 9) >> 1, 4, "Load Game"    , 4, 5, yeti->game.menu.main == 2);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 7) >> 1, 5, "Credits"      , 4, 5, yeti->game.menu.main == 3);
#endif
}
...
#else
  draw_string(yeti->viewport.back, ((YETI_TEXTPORT_WIDTH >> 1) - 14) >> 1, 1, "Select Episode", 4, 5, DRAW_MODE_COLORKEY, 0);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 9) >> 1, 3, "Evil Dead"      , 4, 5, yeti->game.menu.episode == 0);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 14) >> 1, 4, "Secret Caverns" , 4, 5, yeti->game.menu.episode == 1);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 10) >> 1, 5, "The Temple"     , 4, 5, yeti->game.menu.episode == 2);
#endif
}
...
#else
  draw_string(yeti->viewport.back, ((YETI_TEXTPORT_WIDTH >> 1) - 12) >> 1, 1, "Choose Skill", 4, 5, DRAW_MODE_COLORKEY, 0);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 4) >> 1, 3, "Easy"       , 4, 5, yeti->game.menu.skill == 0);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 6) >> 1, 4, "Normal"     , 4, 5, yeti->game.menu.skill == 1);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 10) >> 1, 5, "Nightmare!" , 4, 5, yeti->game.menu.skill == 2);
#endif
}
...
void draw_option(yeti_t* yeti, int x, int y, char* s, int xs, int ys, int selected, int value)
{
  ...
  if (value ==  0) strcpy(p, "Off"); else
  if (value == -1) strcpy(p, "On"); else ansic_itos(value, p);
...
void screen_view_options(yeti_t* yeti)
{
  ...
  screen_flames(yeti, 0);
  draw_option(yeti, 1, l++, "Messages"    , x, y, yeti->game.menu.option == 0, 0);
  draw_option(yeti, 1, l++, "SFX"         , x, y, yeti->game.menu.option == 1, 0);
  draw_option(yeti, 1, l++, "Music"       , x, y, yeti->game.menu.option == 2, 0);
  draw_option(yeti, 1, l++, "Lighting"    , x, y, yeti->game.menu.option == 3, 0);
  draw_option(yeti, 1, l++, "Brightness"  , x, y, yeti->game.menu.option == 4, yeti->visual.brightness);
  draw_menu_item(yeti, 1, l++, "Set Controls" , x, y, yeti->game.menu.option == 5);
}
...
#else
  draw_string(yeti->viewport.back, (YETI_TEXTPORT_WIDTH >> 1) - 5, 13, s, 4, 4, DRAW_MODE_COLORKEY_BLEND, 0);
#endif
}
...
#else
  draw_string(yeti->viewport.back, ((YETI_TEXTPORT_WIDTH >> 1) - 11) >> 1, 1, "Game Paused", 4, 5, DRAW_MODE_COLORKEY, 0);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 11) >> 1, 5, "Resume Play"  , 4, 4, yeti->game.menu.paused == 0);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 7) >> 1, 6, "Options"      , 4, 4, yeti->game.menu.paused == 1);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 9) >> 1, 7, "Load Game"    , 4, 4, yeti->game.menu.paused == 2);
  draw_menu_item(yeti, ((YETI_TEXTPORT_WIDTH >> 1) - 9) >> 1, 8, "Quit Game"    , 4, 4, yeti->game.menu.paused == 3);
#endif
}
